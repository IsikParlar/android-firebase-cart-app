...
import com.example.androidcartfirebase.eventbus.MyUpdateCartEvent;
import com.example.androidcartfirebase.listener.ICartLoadListener;
import com.example.androidcartfirebase.listener.IRecyclerViewClickListener;
                ...
                .addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        if (snapshot.exists()){ //If user already have item in cart
                            //Just upadte quantity and totalPrice
                        ...
                        else{ //If item have not in cart, add new
